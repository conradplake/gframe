...
public class WorldTester extends DoubleBufferedFrame implements MouseMotionListener {
	...
	public void initWorld() {	
		...
		Model3D skydome = Model3DGenerator.buildSkydome(20000, lightskyblue);
		...
		Model3D terrain = Model3DGenerator.buildTerrainMeshFromHeightMap(new File("./textures/height/jotunheimen.png"), 256, 256, Color.GREEN);
		Model3DGenerator.colorTerrainMesh(terrain);
...
//		Model3D terrain = Model3DGenerator.buildRandomVoronoiTerrainMesh(meshX, meshY, tilesize, 100, Color.GREEN);
		...
		Model3DGenerator.laplacianSmooth(meshX, meshY, terrain);
		terrain.move(-meshX*tilesize/2, -200, -meshY*tilesize/2);
		engine.register(terrain, new PhongShader(engine.getLightsource()));
...
//		g.drawImage(frame.createImage(), 0, 0, frame.getWidth(), frame.getHeight(), null);
	...
	public static void main(String[] args) {
		WorldTester main = new WorldTester();
		main.start();
	}
