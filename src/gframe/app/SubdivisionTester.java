...
//		frontModel.rotate(0, 0, 211);
		...
		if (event.getID() == KeyEvent.KEY_PRESSED) {
			...
			if (keycode == KeyEvent.VK_ESCAPE) {
				...
				// CAM CONTROL
					...
					Model3DGenerator.loopSubdivide(frontModel);
					for(Face face : frontModel.getFaces()){
	...
	public static void main(String[] args) {
		SubdivisionTester main = new SubdivisionTester();
		main.start();
	}
